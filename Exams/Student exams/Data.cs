...
namespace Student_exams
{
    class Data
    {
        ...
        public static Stage[] stages = { new Stage(new Point(1, 100), checkpointS1, 9, 4, 20, 2500, 60, 3), new Stage(new Point(1, 100), checkpointS2, 5, 5, 20, 7500, 250, 3), new Stage(new Point(1, 80), checkpointS3, 3, 7, 5, 10000, 250, 1) };
